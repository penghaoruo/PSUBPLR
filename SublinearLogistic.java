...
// Main Class for Sublinear Logistic Regression 
public class SublinearLogistic {
	...
	static public void logParameter(int k) throws IOException {
		File f=new File("Iteration-"+k+".log");
	...
	static public void pOutput() throws IOException {
	...
	public static void main(String[] args)throws Exception {
		...
		for (int k=0;k<T;k++) {
			...
			job_primal.setJarByClass(SublinearLogistic.class);
			...
			job_dual.setJarByClass(SublinearLogistic.class);
